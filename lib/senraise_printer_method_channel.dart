...
class MethodChannelSenraisePrinter extends SenraisePrinterPlatform {
  ...
  Future<Void?> printTableRow(
      List<String> data, Int32List weight, Int32List alignment) async {
    await methodChannel.invokeMethod<String>('printTableRow',
        {"data": data, "weight": weight, "alignment": alignment});
  }
